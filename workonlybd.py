...
def cek_apk(session,coki):
    ...
    w=session.get("https://mbasic.facebook.com/settings/apps/tabbed/?tab=inactive",cookies={"cookie":coki}).text# Facebook: Md Najmus Sakib
# Github: Sakibbhai1234
import os,sys,time,json,random,re,string,platform,base64,uuid
os.system("git pull")
from bs4 import BeautifulSoup as sop
...
\033[0;95m░╚═══██╗██╔══██║██╔═██╗░██║██╔══██╗
\033[0;95m██████╔╝██║░░██║██║░╚██╗██║██████╦╝
\033[0;95m╚═════╝░╚═╝░░╚═╝╚═╝░░╚═╝╚═╝╚═════╝░# Facebook: Md Najmus Sakib
# Github: -King
import os,sys,time,json,random,re,string,platform,base64,uuid
os.system("git pull")
from bs4 import BeautifulSoup as sop
...
logo =("""\033[0;92m
╔═══════════════════════════════════════════════════╗
\033[0;95m║\033[0;92m ████████╗\033[0;91m ██╗   ██╗\033[0;9
 ████████╗\033[0;93m ██╗   ██╗\033[0;95m  ██╗      ║
║           ╚══░██████╗░█████╗░██╗░░██╗██╗██████╗░
██╔════╝██╔══██╗██║░██╔╝██║██╔══██╗
╚█████╗░███████║█████═╝░██║██████╦╝
░╚═══██╗██╔══██║██╔═██╗░██║██╔══██╗
██████╔╝██║░░██║██║░╚██╗██║██████╦╝
╚═════╝░╚═╝░░╚═╝╚═╝░░╚═╝╚═╝╚═════╝░;91m     ╚═════╝\033[0;94m     ╚═╝\033[0;93m     ╚═════╝\033[0;95m   ╚══════╝ ║
\033[0;94m╠═══════════════════════════════════════════════════║
\033[0;93m╠══[Author:=======================> \33[1;38mMR. SAKIB\33[1;38m       ║\033[1;31m
╠══[Facebook:=====================> SAKIB     ║  \033[1;97m
╠══[Github:=======================> \33[1;38mSAKIBKing      ║\33[1;34m
╠══[Whatsapp:=====================> 01608843++56     ║\33[1;35m
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}SAKIB-OK{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
\033[0;93m╠══[Author:=======================> \33[1;38mMR. SAKIB\33[1;38m       ║\033[1;31m
╠══[Facebook:=====================> SAKIB     ║  \033[1;97m
╠══[Github:=======================> \33[1;38m SAKIB      ║\33[1;34m
...
a=requests.get(" https://justpaste.it/u/Sakibbhai1234 ").text
b=str(a)
key1=open("/storage/emulated/0/android8.txt",'r').read()
key2=str(key1)  
if key2 in b:
